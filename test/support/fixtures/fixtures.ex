defmodule ExGoogleSTT.Fixtures do
  ...
  def interim_results do
    [
      ...
      "adventure 1 a scandal in bohemia from the adventures of sherlock holmes by sir ar",
      "adventure 1 a scandal in bohemia from the adventures of sherlock holmes by sir arth",
      "adventure 1 a scandal in bohemia from the adventures of sherlock holmes by sir arthur",
      "adventure 1 a scandal in bohemia from the adventures of sherlock holmes by sir arthur con",
      "adventure 1 a scandal in bohemia from the adventures of sherlock holmes by sir arthur con",
